...
export default function Hero({ onRequestCallback }: HeroProps) {
  ...
  return (
    <section
      id="home"
      className="relative min-h-[280px] lg:min-h-[70vh] flex flex-col justify-center overflow-hidden bg-white pt-24 pb-12 lg:pt-32 lg:pb-16"
    >
      ...
      <div className="relative z-10 content-container w-full">
        <div className="max-w-3xl">
          {/* Badge */}
          <div className="inline-flex items-center gap-1.5 lg:gap-2 px-3 py-1.5 lg:px-4 lg:py-2 rounded-full bg-white border border-primary/10 text-primary font-medium text-xs lg:text-sm mb-4 lg:mb-6 shadow-sm animate-fade-in-up">
          ...
          {/* Subtitle */}
          <p className="text-base lg:text-xl text-gray-600 max-w-xl mb-6 lg:mb-8 animate-fade-in-up stagger-2 leading-relaxed">
          ...
          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row flex-wrap gap-4 mb-8 lg:mb-12 animate-fade-in-up stagger-3">
            <button
              onClick={onRequestCallback}
              className="px-8 py-4 rounded-2xl font-semibold text-white bg-primary hover:bg-primary-dark shadow-lg shadow-primary/30 transition-all duration-300 hover:-translate-y-1 flex items-center justify-center gap-2 min-h-[44px]"
            >
            ...
            <a
              ...
              className="px-8 py-4 rounded-2xl font-semibold text-white bg-[#25D366] hover:bg-[#20bd5a] shadow-lg shadow-[#25D366]/30 transition-all duration-300 hover:-translate-y-1 flex items-center justify-center gap-2 min-h-[44px]"
            >
